...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Production 5-Agent Swarm | 88.8 | 91.0 | 92.0 | 90.0 | 82.0 | 81.0 | 97.0 | 84.0 | 4800.0 | 0.1 | ok |
...
Production Swarm Score: 88.8
Best Simpler Baseline Score: 83.95
Swarm Advantage Score: 4.85
...
|---|---:|---:|---:|---|
| Critic agent | 88.8 | 80.65 | 8.15 | Keep always-on |
| Reflection loop | 88.8 | 81.6 | 7.2 | Keep always-on |
| RRF memory retrieval | 88.8 | 80.6 | 8.2 | Keep always-on |
| Nightly Mutation Engine | 88.8 | 81.95 | 6.85 | Keep always-on |
| CORAL / Meta-LLM | 88.8 | 80.4 | 8.4 | Keep always-on |

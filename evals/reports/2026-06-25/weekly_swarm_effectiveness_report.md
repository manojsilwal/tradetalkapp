...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Production 5-Agent Swarm | 93.0 | 93.0 | 97.0 | 91.0 | 90.0 | 92.0 | 99.0 | 86.0 | 3800.0 | 0.08 | ok |
...
Production Swarm Score: 93.0
Best Simpler Baseline Score: 84.05
Swarm Advantage Score: 8.95
...
|---|---:|---:|---:|---|
| Critic agent | 93.0 | 81.0 | 12.0 | Keep always-on |
| Reflection loop | 93.0 | 81.75 | 11.25 | Keep always-on |
| RRF memory retrieval | 93.0 | 81.9 | 11.1 | Keep always-on |
| Nightly Mutation Engine | 93.0 | 82.05 | 10.95 | Keep always-on |
| CORAL / Meta-LLM | 93.0 | 80.55 | 12.45 | Keep always-on |

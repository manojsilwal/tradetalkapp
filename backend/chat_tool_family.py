...
CHAT_TOOL_FAMILY_BY_NAME: dict[str, ToolFamily] = {
    ...
    "get_filing_intelligence": ToolFamily.FILING,
    "get_options_flow": ToolFamily.MARKET_DATA,
...
TOOL_NAMESPACE_BY_NAME: dict[str, MemoryNamespace] = {
    ...
    "get_filing_intelligence": MemoryNamespace.NEWS_RAG,
    "get_options_flow": MemoryNamespace.MARKET_DATA,
...
TOOL_RETRIEVAL_MODE_BY_NAME: dict[str, str] = {
    ...
    "get_filing_intelligence": "recency_weighted",
    "get_options_flow": "live_fetch",
...
SOURCE_REF_ARTIFACT_TYPE_BY_TOOL: dict[str, str] = {
    ...
    "get_filing_intelligence": "filing_excerpt",
    "get_options_flow": "market_quote",

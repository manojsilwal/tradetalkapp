...
const API_CATALOG = [
    ...
    },
    {
        ...
        description: 'Paper portfolio, morning brief, gamification, and preferences.',
        endpoints: [
            {
                method: 'GET',
            ...
            },
            {
                ...
                summary: 'Personalized morning cards (greeting, movers, continuity)',
                uiSurfaces: ['Paper Portfolio'],
                uiComponent: 'components/YourMorningHero.jsx',
                backendFile: 'backend/routers/portfolio.py',
                auth: 'required',
                request: { query: [] },
                response: {
                    type: 'object',
                    fields: ['greeting, movers[], continuity cards, action prompts'],
                },
                architecture: 'YourMorningHero → personalized dashboard cards from holdings + ledger',
            },
            {
                method: 'GET',
                ...
                response: {
                    type: 'object',
                    fields: ['Win rate, avg return, decision count by horizon'],
                },
                architecture: 'Track record badge → decision-outcome ledger aggregation',
            },
            {
                method: 'GET',
                ...
                uiSurfaces: ['Paper Portfolio'],
                uiComponent: 'components/PortfolioTimeline.jsx',
                backendFile: 'backend/routers/portfolio.py',
                auth: 'required',
                request: {
                    query: [{ name: 'limit', type: 'int', required: false }],
                },
                response: {
                    type: 'object',
                    fields: ['items[] → {type, timestamp, summary, metadata}'],
                },
                architecture: 'Timeline component → chronological portfolio events',
            },
            {
                method: 'GET',
                path: '/portfolio/news',

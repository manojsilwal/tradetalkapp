...
BRAIN_MODEL_VERSION=v2,\
INVESTMENT_SURFACE=1,\
BRAIN_CUTOVER_ALL=0,\
BRAIN_CUTOVER_SWARM=1,\
BRAIN_CUTOVER_DECISION_TERMINAL=1,\
OPTIONS_FLOW_ENABLE=1,\
FILING_INTELLIGENCE_ENABLE=1,\
FILING_INTELLIGENCE_UNIVERSE=recent_filings_only,\
FILING_INTELLIGENCE_TTL_DAYS=7,\
FILING_INTELLIGENCE_CONCURRENCY=4,\
FILING_INTELLIGENCE_LIVE_INJECT=1,\
FILING_INTELLIGENCE_AGENT_TOOL=1,\
ALLOW_PROVIDER_SMOKE=1,\
FUND_LB_RANKING_MODE=EXTERNAL_AUM_CURATED,\
DATA_LAKE_SOURCE=hf,\
HF_DATASET_ID=manojsilwal44/tradetalk-data"
...
_CORE_ENV_KEYS="MCP_DATA_BACKEND GCP_PROJECT_ID BQ_DATASET_ID GCS_BUCKET GUARDRAILS_ENABLE GUARDRAILS_STRICT_STARTUP VECTOR_BACKEND SUPABASE_URL DECISION_BACKEND VERDICT_CACHE_BACKEND GEMINI_EMBEDDING_MODEL CORS_ORIGINS PORTFOLIO_STORAGE SP500_INGEST_ON_STARTUP FINCRAWLER_URL YF_DISABLED_CATEGORIES FINCRAWLER_MAX_CONCURRENCY YF_BREAKER_THRESHOLD YF_BREAKER_COOLDOWN_S SEPL_TOOL_ENABLE SEPL_TOOL_DRY_RUN SEPL_TOOL_AUTOCOMMIT LLM_HTTP_PROVIDER GEMINI_PRIMARY GEMINI_LLM_FALLBACK GEMINI_MODEL GEMINI_MODEL_LIGHT LLM_MAX_TOKENS OPENROUTER_MODEL OPENROUTER_MODEL_LIGHT STORAGE_BACKEND BRAIN_GCS_BUCKET BRAIN_GCS_PREFIX BRAIN_SERVE_ENABLE BRAIN_MODEL_VERSION INVESTMENT_SURFACE BRAIN_CUTOVER_ALL BRAIN_CUTOVER_SWARM BRAIN_CUTOVER_DECISION_TERMINAL OPTIONS_FLOW_ENABLE FILING_INTELLIGENCE_ENABLE FILING_INTELLIGENCE_UNIVERSE FILING_INTELLIGENCE_TTL_DAYS FILING_INTELLIGENCE_CONCURRENCY FILING_INTELLIGENCE_LIVE_INJECT FILING_INTELLIGENCE_AGENT_TOOL ALLOW_PROVIDER_SMOKE FUND_LB_RANKING_MODE DATA_LAKE_SOURCE HF_DATASET_ID"
...
gcloud run deploy "$SERVICE_NAME" \
  ...
  --set-secrets "YOUTUBE_API_KEY=YOUTUBE_API_KEY:latest,GEMINI_API_KEY=GEMINI_API_KEY:latest,HF_TOKEN=HF_TOKEN:latest" \
  --quiet

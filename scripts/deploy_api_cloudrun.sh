...
_CORE_ENV_KEYS="MCP_DATA_BACKEND GCP_PROJECT_ID BQ_DATASET_ID GCS_BUCKET GUARDRAILS_ENABLE GUARDRAILS_STRICT_STARTUP VECTOR_BACKEND SUPABASE_URL DECISION_BACKEND VERDICT_CACHE_BACKEND GEMINI_EMBEDDING_MODEL CORS_ORIGINS PORTFOLIO_STORAGE SP500_INGEST_ON_STARTUP FINCRAWLER_URL YF_DISABLED_CATEGORIES FINCRAWLER_MAX_CONCURRENCY YF_BREAKER_THRESHOLD YF_BREAKER_COOLDOWN_S SEPL_TOOL_ENABLE SEPL_TOOL_DRY_RUN SEPL_TOOL_AUTOCOMMIT LLM_HTTP_PROVIDER GEMINI_PRIMARY GEMINI_LLM_FALLBACK GEMINI_MODEL GEMINI_MODEL_LIGHT LLM_MAX_TOKENS OPENROUTER_MODEL OPENROUTER_MODEL_LIGHT"
